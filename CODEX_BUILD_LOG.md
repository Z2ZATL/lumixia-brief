...
| BL-016 | Native Supabase Auth migration              | same                                   | PKCE Google OAuth, mandatory TOTP/AAL2, native JWT/RLS, separate-tab Notion OAuth handoff, safe local demo             | Static/unit/UI/Auth-RLS/E2E, live Notion v1/v2 idempotency, Docker and scans | `2440e15`…`db6c7c8` / [PR #24](https://github.com/Z2ZATL/lumixia-brief/pull/24) / [CI](https://github.com/Z2ZATL/lumixia-brief/actions/runs/29508110218)             |
