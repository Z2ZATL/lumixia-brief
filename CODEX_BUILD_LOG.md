...
| BL-007 | Quality and defect hardening            | same                                   | Atomic retries, optimistic concurrency, complete Notion sync, privacy hardening, dead-code and strict gates | Unit/API/UI/RLS/E2E, build, audit, Docker and Trivy            | pending PR publication                                                             |
