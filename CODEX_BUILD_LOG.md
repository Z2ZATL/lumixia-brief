...
| BL-014 | Backend completion without paid OpenAI      | same                                   | Independent provider modes, disabled-model contract, cancellation, full-backend coverage, operator seed, release gates | 84 unit/API tests, 8 UI, 10 RLS, 6 E2E, Docker, audits and scans   | Pending publication                                                                                                                                                  |
