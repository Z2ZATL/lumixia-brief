...
| BL-016 | Native Supabase Auth migration              | same                                   | PKCE Google OAuth, mandatory TOTP/AAL2, native JWT/RLS, separate-tab Notion OAuth handoff, safe local demo, release rehearsal | Static/unit/UI/Auth-RLS/E2E, Production AAL2 and Notion v1/v2 sync, rollback and false-status regressions | `b9617bd`…`2d174ef`, `a20f247` / [PR #24](https://github.com/Z2ZATL/lumixia-brief/pull/24), [PR #27](https://github.com/Z2ZATL/lumixia-brief/pull/27) / [CI](https://github.com/Z2ZATL/lumixia-brief/actions/runs/29605280734) |
