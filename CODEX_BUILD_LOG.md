...
| BL-016 | Native Supabase Auth migration              | same                                   | PKCE Google OAuth, mandatory TOTP/AAL2, native JWT/RLS, bearer API, provider residue removal, safe local demo          | Static/unit/UI/Auth-RLS/E2E, coverage, build, Docker and scans     | `2440e15`…`7885587` / [PR #24](https://github.com/Z2ZATL/lumixia-brief/pull/24) / [CI](https://github.com/Z2ZATL/lumixia-brief/actions/runs/29500510524)             |
