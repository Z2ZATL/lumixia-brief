...
| BL-016 | Native Supabase Auth migration              | same                                   | PKCE Google OAuth, mandatory TOTP/AAL2, native JWT/RLS, bearer API, provider residue removal, safe local demo          | Static/unit/UI/Auth-RLS/E2E, coverage, build, Docker and scans     | pending                                                                                                                                                              |
